...
######################################################
        ...
        if message.content == '>Help':
            await message.channel.send("""
                            Привет! Этот бот пока сыроват, но вот все команды кейсов их шансы:
                                - '>Обычный кейс':
                                       Ничего-40%
                                       500 сыра-30%
                                       750 сыра-20%
...
##                await message.channel.send('Ты ничего не выиграл. Повезёт в следущий раз!')
##            elif s == 1:
##                await message.channel.send('Поздравляю! Ты выйграл  сыра!')
##            elif s == 2:
##                await message.channel.send('Поздравляю! Ты выйграл  сыра!')
##            elif s == 5:
##                await message.channel.send('Поздравляю! Ты выйграл  сыра!')
